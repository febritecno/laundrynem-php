                            ...
                            <div class="x_panel">
                                ...
                                <h2>Tabel Konten<small>tambah, edit, hapus dan cetak</small></h2>
                                    ...
                                    <ul class="nav navbar-right panel_toolbox">
                                        ...
                                        <li><a href="pemakaian_barang_print" target="BLANK"><i class="fa fa-print"></i></a>
...
<!-- Modal -->
 ...
 <!--isi modal-->
              ...
              <label for="nik">Kode Pengeluaran<span class="required">*</span></label>
              ...
              <input type="text" class="form-control" id="nm" data-validate-length-range="5" data-validate-words="1" placeholder="minimal 2 dikit [angka]" required="required">
                   </div>
                  </div>
<!--/isi modal-->
...
//gawe tambah data
   $.ajax({
       type: "POST",
       url: "pemakaian_barang_tambah.php",
       data: datas,
       dataType: "html"
   }).done(function( msg ) {
       alert( msg );
...
function deletedata(str){
   ...
   $.ajax({
       type: "POST",
       url: "pemakaian_barang_delete.php",
       data: "nik="+nik,
       dataType: "html"
   }).done(function( msg ) {
       alert( msg );
...
function updatedata(str){
   ...
   var datas = "nik="+nik+"&nm="+nm;
    ...
    $.ajax({
       type: "POST",
       url: "pemakaian_barang_update.php",
       data: datas,
       dataType: "html"
   }).done(function( msg ) {
       alert( msg );
