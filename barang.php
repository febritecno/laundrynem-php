...
if ($_SESSION['typeuser']=='admin'){
   echo '<li><a href="barang_print" target="BLANK"><i class="fa fa-print"></i></a>';
...
<!-- Modal -->
 ...
 <!--isi modal-->
              ...
              <label for="kb">Kode Barang<span class="required">*</span></label>
              <input type="number" class="form-control" id="kb" data-validate-length-range="3" data-validate-words="1" placeholder="wajib di isi 3 dikit [angka]" required="required">
                   </div>
              ...
              <input type="text" class="form-control" id="sb">
                   ...
                   <div class="form-group">
              <label for="tus">Tanggal Update Stok Barang</label>
              <input type="text" class="form-control" id="tus" data-inputmask="'mask': '9999/99/99'" data-validate-length-range="10" data-validate-words="1" placeholder="[tahun]/[bulan]/[tanggal]" required="required">
                   </div>
...
function timedRefresh(timeoutPeriod) {
  ...
  //gawe tampiklan data
   ...
   var datas = "kb="+kb+"&nb="+nb+"&sb="+sb+"&tus="+tus;

//gawe tambah data
   $.ajax({
       type: "POST",
       url: "barang_tambah.php",
       data: datas,
       dataType: "html"
   }).done(function( msg ) {
       alert( msg );
