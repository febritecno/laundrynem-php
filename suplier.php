                            ...
                            <div class="x_panel">
                                ...
                                <h2>Tabel Konten<small>tambah, edit, hapus dan cetak</small></h2>
                                    ...
                                    <ul class="nav navbar-right panel_toolbox">
                                        ...
                                        <li><a href="suplier_print" target="BLANK"><i class="fa fa-print"></i></a>
...
<!-- Modal -->
 ...
 <!--isi modal-->
              ...
              <label for="is">ID Suplier<span class="required">*</span></label>
              <input type="number" class="form-control" id="is" data-validate-length-range="5" data-validate-words="1" placeholder="wajib di isi 5 dikit [angka]" required="required">
                   </div>
              ...
              <input type="text" class="form-control" id="nt" data-inputmask="'mask': '(999)99999999'">
                   </div>
...
function timedRefresh(timeoutPeriod) {
  ...
  //gawe tampiklan data
   ...
   var datas = "is="+is+"&ns="+ns+"&as="+as+"&nt="+nt;

//gawe tambah data
   $.ajax({
       type: "POST",
       url: "suplier_tambah.php",
       data: datas,
       dataType: "html"
   }).done(function( msg ) {
       alert( msg );
